...
/**
 * A Foundations page rather than a component: it renders plain HTML inside
 * `.uc-content` so the theme's prose defaults can be read at their real scale
 * and under every theme.
 */
@Component({
  selector: 'uc-html-content-preview',
  template: `
    <article class="uc-content">
      ...
      <p>These styles apply automatically when the default theme stylesheet is imported.</p>
      ...
      <p>
        ...
        <code>uc-body</code>, <code>uc-muted</code>, <code>uc-code</code>, <code>uc-pre</code>, and
        <code>uc-table</code>.
      </p>
      ...
      <ul>
        ...
        <li>Inline snippets such as <code>npm run workbench</code> stay readable.</li>
...
export class HtmlContentPreview {}
